<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"F:\www\youme\think\public/../application/index\view\index\index.html";i:1509542397;s:68:"F:\www\youme\think\public/../application/index\view\common\head.html";i:1509531295;s:70:"F:\www\youme\think\public/../application/index\view\common\footer.html";i:1508655809;}*/ ?>
	...
	<?php endforeach; endif; else: echo "" ;endif; ?>
		...
		<div id="divMain">
			...
			<div class="post multi-post cate4 auth1">
				...
				<h2 class="post-title">
					<a href="http://www.youmew.com/post/77.html"><?php echo $vo['title']; ?></a>
				</h2>
				<div class="post-body">
				...
				<h6 class="post-footer">发布:<?php echo $vo['author']; ?>  浏览:<?php echo $vo['click']; ?><span id="spn77"></span>
					<script type="text/javascript">LoadViewCount(77)</script> | <a href="<?php echo url('article/article',array('id' => $vo['id'])); ?>">阅读全文 > </a>
				</h6>
			</div>
		<?php endforeach; endif; else: echo "" ;endif; ?>
